  ...
  <main class="auth-page">
    <section class="auth-card">
      <a class="auth-brand" href="{{ route('login') }}">
        ...
        <span><strong>UniGestion</strong><small>Create your UniGestion account.</small></span>
      </a>
      <div class="auth-visual">
        <img src="{{ asset('assets/images/png/dasher-ui-bootstrap-5.jpg') }}" alt="UniGestion dashboard interface">
      </div>
      ...
      <form class="needs-validation" method="POST" action="{{ route('register.post') }}" novalidate>
        ...
        <div class="mb-3">
          ...
          <input class="form-control" id="registerName" name="name" type="text"
        ...
        <div class="mb-3">
          ...
          <input class="form-control" id="registerEmail" name="email" type="email"
        ...
        <div class="mb-3">
          ...
          <input class="form-control" id="registerPassword" name="password"
        ...
        <div class="mb-3">
          ...
          <input class="form-control" id="registerPasswordConfirm" name="password_confirmation"
                 type="password" minlength="6" required>
      ...
      <div class="auth-footer">
        Already have an account? <a href="{{ route('login') }}">Se connecter</a>
      </div>
    </section>
  </main>
