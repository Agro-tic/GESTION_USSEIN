...
<div class="container-fluid px-3 px-lg-4 py-4">
    ...
    <form action="{{route('agent.update', $agent->id)}}" method="POST">
        ...
        <div class="col-md-6">
            ...
            <input class="form-control" type="text" name="nom" id="nom" value="{{ old('nom', $agent->nom)}}" required>
        </div>
        <div class="col-md-6">
            <label for="prenom"class="form-label fw-semibold">Prenom</label>
            <input class="form-control" type="text" name="prenom" id="prenom" value="{{old('prenom',$agent->prenom)}}" required>
        </div>
        <div class="col-md-6">
            <label for="matricule"class="form-label fw-semibold">Matricule</label>
            <input class="form-control" type="text" name="matricule" id="matricule" value="{{old('matricule',$agent->matricule)}}" required>
            @error('matricule')
        ...
        <div class="col-md-6">
            ...
            <input class="form-control" type="text" name="lieu_affectation" id="lieu_affectation" value="{{old('lieu_affectation',$agent->lieu_affectation)}}" required>
        </div>

        <div class="col-md-6">
            <label for="date_prise_service" class="form-label fw-semibold">Date de prise de service</label>
            <input class="form-control" type="date" name="date_prise_service" id="date_prise_service" value="{{old('date_prise_service',$agent->date_prise_service)}}" required>
        </div>
       ...
       <div class="col-md-6">
            ...
            <input class="form-control" type="number" name="nb_enfants" id="nb_enfants"value="{{ old('nb_enfants', $agent->nb_enfants) }}" min="0" required>
        </div>

        <div class="col-md-6">
            <label for="jours_conges_annee_precedente" class="form-label fw-semibold">Congés année précédente</label>
            <input class="form-control" type="number" name="jours_conges_annee_precedente" id="jours_conges_annee_precedente"value="{{ old('jours_conges_annee_precedente',$agent->jours_conges_annee_precedente) }}" min="0" required>
        </div>

        <div class="col-md-6">
            <label for="jours_conges_annee_courante" class="form-label fw-semibold">Congés année courante</label>
            <input class="form-control" type="number" name="jours_conges_annee_courante" id="jours_conges_annee_courante"value="{{ old('jours_conges_annee_courante',$agent->jours_conges_annee_courante) }}" min="0" required>
        </div>

        <div class="col-md-6">
            <label for="absences_defalquer" class="form-label fw-semibold">Absences défalquées</label>
            <input class="form-control" type="number" name="absences_defalquer" id="absences_defalquer"value="{{ old('absences_defalquer',$agent->absences_defalquer) }}" min="0" required>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input class="form-control" type="number" name="annee_courante" id="annee_courante"  value="{{ old('annee_courante', $agent->annee_courante) }}" readonly  required>
        </div>
