...
(function () {
  ...
  onReady(function () {
    ...
    function initSidebarAccordion() {
      var accordions = document.querySelectorAll(".nav-accordion");

      Array.prototype.forEach.call(accordions, function (btn) {
        btn.addEventListener("click", function () {
          ...
          Array.prototype.forEach.call(accordions, function (b) {
          ...
          // Ouvre seulement si c'était fermé
          if (!isOpen && submenu) {
    ...
    initThemeToggle();
    initUserProfile();
    initSidebarAccordion(); // ← dans onReady, DOM disponible
